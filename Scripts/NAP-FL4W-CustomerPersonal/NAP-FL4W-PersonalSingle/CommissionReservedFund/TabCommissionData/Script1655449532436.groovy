...
if(WebUI.verifyElementNotVisible(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/a_Commission Reserved Fund'),FailureHandling.OPTIONAL)){
...
WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/a_Commission Reserved Fund'))

WebUI.delay(5)
'Input Appno'
WebUI.setText(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/input_Application No_AppNoId'), 
...
'Klik Search'
WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/button_Search'))

'Klik Select'
WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/i_Select'))
...
allocationType = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm, 2)

'Select dropdownlist allocation type'
WebUI.selectOptionByLabel(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/select_AmountPercentage'), 
...
if(variableSupp.size()>0){
	...
	String supplierName = WebUI.getText(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_SupplierName'))
	
	'Mengambil nilai supplier name yang akan didelete dari excel'
	String deleteSupp = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm, 4)
	...
	if (supplierName.equalsIgnoreCase(deleteSupp)) {
		...
		WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/i_deletesupp'))
		'Click OK pada alert'
		WebUI.acceptAlert()
	} else {
		String supplierCode
		...
		WebUI.selectOptionByIndex(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/select_BankAccountSupplier'),
			findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm, 5), FailureHandling.OPTIONAL)
		...
		for (int i = 1; i <= countAllocateCommission; i++) {
			...
			modifyObjectAllocateCommission = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_Allocate Commission Supp'),
			...
			modifyObjectCommissionAmt = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/input_Admin Fee SUPP (Amt)'),
				'xpath', 'equals', newxpathCommissionAmt, true)
			modifyObjectCommissionPercentage = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/input__AdminFee SUPP (Percentage)'),
				'xpath', 'equals', newxpathCommissionPercentage, true)
			
			'Pengecekan allocation type jika amount'
			if(allocationType == "Amount"){
				
				if(findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,
						(2 * i) + 4)!=""){
					...
					WebUI.setText(modifyObjectCommissionAmt, findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,
				...
				if(findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,
					...
					WebUI.setText(modifyObjectCommissionPercentage, findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,
			...
			if(amt!=0 && pctg!=0){
				...
				for(int j = 1;j<=countIncomeInfo;j++){
					...
					modifyObjectIncomeInfo = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_Upping Rate'),
					...
					modifyObjectIncomeInfoAmt = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_IncomeUppingRate'),
...
if(variableSuppEmp.size()>0){
	...
	for (int i = 1; i <= variableSuppEmp.size(); i++) {
		...
		modifyObjectSuppEmpName = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_SuppEmpName'),
		...
		modifyObjectSupplierName = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_SupplierNameSuppEmp'),
		...
		modifyObjectSupplierEmpPos = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_SuppEmpPosition'),
		...
		def deleteSuppEmpName = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(
				GlobalVariable.NumofColm, suppEmpRow+1)
	
		'Mengambil dan menyimpan posisi dari supplier employee dari excel yang akan didelete'
		def deleteSuppEmpPos = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(
		...
		if(deleteSuppEmpName.length()>0 && deleteSuppEmpPos.length()>0){
			...
			for(j=1;j<=deleteSuppEmpName.size();j++){
				...
				if(supplierEmployeeName.equalsIgnoreCase(deleteSuppEmpName[j-1]) && supplierEmpPos.equalsIgnoreCase(deleteSuppEmpPos[j-1])){
					...
					modifyDelSuppEmp = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/i_deleteSuppEmp'),
		...
		if(flagdelSuppEmployee!=0){
			...
			modifyObjectBankAccount = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/select_BankAccountSuppEmp'),
						 'xpath', 'equals', newxpathBankAccount, true)
					 
			'Mengambil nama bank account supplier employee pada excel'
			def bankAccSuppEmp = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(
			...
			for (int j = 1; j <= countAllocateCommission; j++) {
				...
				modifyObjectAllocateCommission = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_Allocate Commission Supp Emp'),
					'xpath', 'equals', newxpathAllocateCommission, true)
				
				'Menyimpan nama fee/income allocate commission from dari web confins'
				String allocateCommission = WebUI.getText(modifyObjectAllocateCommission).replace(" (AMT/%)","").replaceAll("\\s","")
	
				modifyObjectCommissionAmt = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/input_Admin Fee supp emp (Amt)'),
					'xpath', 'equals', newxpathCommissionAmt, true)
				modifyObjectCommissionPercentage = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/input__AdminFee()SuppEmp'),
					'xpath', 'equals', newxpathCommissionPercentage, true)
				...
				if(allocationType == "Amount"){
					...
					value = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 2 + suppEmpRow).split(";",-1)
					if(findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 2 + suppEmpRow).length()>0){
					...
					value = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 3 + suppEmpRow).split(";",-1)
					if(findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 3 + suppEmpRow).length()>0){
...
if(variableRef.size()>0){
	...
	for (int i = 1; i <= variableRef.size(); i++) {
		...
		modifyObjectRefName = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_RefName'),
		...
		def deleteRefName = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(
		...
		if(deleteRefName.length()>0){
			...
			for(j=1;j<=deleteRefName.size();j++){
				...
				if(refName.equalsIgnoreCase(deleteRefName[j-1])){
					...
					modifyDelRef = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/i_deleteref'),
		...
		if(flagdelReferantor!=0){
			...
			modifyObjectBankAccount = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/select_bankAccRef'),
						 'xpath', 'equals', newxpathBankAccount, true)
					 
			'Mengambil nama bank account referantor pada excel'		 
			def bankAccRef = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(
			...
			for (int j = 1; j <= countAllocateCommission; j++) {
				...
				modifyObjectAllocateCommission = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_Allocate Commission Ref'),
					'xpath', 'equals', newxpathAllocateCommission, true)
				
				'Menyimpan nama fee/income allocate commission from dari web confins'
				String allocateCommission = WebUI.getText(modifyObjectAllocateCommission).replace(" (AMT/%)","").replaceAll("\\s","")

				modifyObjectCommissionAmt = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/input_Admin Fee Ref(Amt)'),
					'xpath', 'equals', newxpathCommissionAmt, true)
				modifyObjectCommissionPercentage = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/input__AdminFee Ref ()'),
					'xpath', 'equals', newxpathCommissionPercentage, true)
				...
				if(allocationType == "Amount"){
					...
					value = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 1 + refRow).split(";",-1)
					
					if(findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 1 + refRow).length()>0){
						if(value[i-1]!=""){
							'Input Amount'
							WebUI.setText(modifyObjectCommissionAmt, value[i-1] , FailureHandling.OPTIONAL)
						}
					...
					value = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 2 + refRow).split(";",-1)
					
					if(findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 2 + refRow).length()>0){
						if(value[i-1]!=""){
							'Input Percentage'
							WebUI.setText(modifyObjectCommissionPercentage, value[i-1] , FailureHandling.OPTIONAL)
						}
...
'Klik Calculate'
WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/button_Calculate'))
...
for (int i = 1; i<=variableSupp.size(); i++){
	 ...
	 modifyObjectCommAmt = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalCommissionAmtSupplier'),
		 'xpath', 'equals', newxpathCommAmt, true)
	 
	 'modify object total commission after tax amount'
	 modifyObjectAmtAftTax = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalCommisssionAfterTaxAmtSupplier'),
		 'xpath', 'equals', newxpathAmtAftTax, true)
	 
	 'modify object withholding tax amount'
	 modifyObjectTax = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_WithHoldingTaxAmtSupp'),
		 'xpath', 'equals', newxpathTax, true)
	 
	 'modify object vat amount'
	 modifyObjectVat = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_VatAmtSupp'),
		 'xpath', 'equals', newxpathVat, true)
	 
	 'modify object disburse amount'
	 modifyObjectDisburse = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_DisburseAmtSupp'),
		 'xpath', 'equals', newxpathDisburse, true)
	 
	 'modify object expense amount'
	 modifyObjectExpense = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_ExpenseAmtSupp'),
...
for (int j = 1; j <= variableSuppEmp.size(); j++) {
	...
	'modify object total commission amount'
	modifyObjectCommAmt = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalCommissionAmtSuppEmp'),
		'xpath', 'equals', newxpathCommAmt, true)
	
	'modify object total commission after tax amount'
	modifyObjectAmtAftTax = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalCommissionAfterTaxAmtSuppEmp'),
		'xpath', 'equals', newxpathAmtAftTax, true)
	
	'modify object withholding tax amount'
	modifyObjectTax = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_WithHoldingTaxAmtSuppEmp'),
		'xpath', 'equals', newxpathTax, true)
	
	'modify object vat amount'
	modifyObjectVat = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_VatAmtSuppEmp'),
		'xpath', 'equals', newxpathVat, true)
	
	'modify object disburse amount'
	modifyObjectDisburse = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_DisburseAmtSuppEmp'),
		'xpath', 'equals', newxpathDisburse, true)
	
	'modify object expense amount'
	modifyObjectExpense = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_ExpenseAmtSuppEmp'),
		'xpath', 'equals', newxpathExpense, true)
...
for(int k=1; k <= variableRef.size(); k++){
	 ...
	 'modify object total commission amount'
	 modifyObjectCommAmt = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalCommissionAmtRef'),
		 'xpath', 'equals', newxpathCommAmt, true)
	 
	 'modify object total commission after tax amount'
	 modifyObjectAmtAftTax = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalCommissionAfterTaxAmtRef'),
		 'xpath', 'equals', newxpathAmtAftTax, true)
	 
	 'modify object withholding tax amount'
	 modifyObjectTax = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_WithHoldingTaxAmtRef'),
		 'xpath', 'equals', newxpathTax, true)
	 
	 'modify object vat amount'
	 modifyObjectVat = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_VatAmtRef'),
		 'xpath', 'equals', newxpathVat, true)
	 
	 'modify object disburse amount'
	 modifyObjectDisburse = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_DisburseAmtRef'),
		 'xpath', 'equals', newxpathDisburse, true)
	 
	 'modify object expense amount'
	 modifyObjectExpense = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_ExpenseAmtRef'),
		 'xpath', 'equals', newxpathExpense, true)
...
String textTotalCommAmt = WebUI.getText(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalCommisionAmt')).replace(",","")

'Mengambil nilai summary total commission after tax amount dari confins'
String textTotalCommAmtAftTax = WebUI.getText(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalCommissionAfterTaxAmt')).replace(",","")

'Mengambil nilai summary total disburse amount dari confins'
String textTotalDisburseAmt = WebUI.getText(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalDisburseAmt')).replace(",","")

'Mengambil nilai summary total expense amount dari confins'
String textTotalExpenseAmt = WebUI.getText(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalExpenseAmt')).replace(",","")

'Mengambil nilai summary total tax dari confins'
String textTotalTax = WebUI.getText(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalTax')).replace(",","")

'Mengambil nilai summary total vat dari confins'
String textTotalVat = WebUI.getText(findTestObject('Object Repository/NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/label_TotalVat')).replace(",","")
...
'Klik save'
WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/button_Save'))

WebUI.delay(3)

'Pengecekan jika setelah klik save, dropdownlist allocation type masih bisa diklik/dipilih'
if (WebUI.verifyElementPresent(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/select_AmountPercentage'), 
    5, FailureHandling.OPTIONAL)) {
    
	'Klik cancel'
    WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/CommissionReservedFund/TabCommissionData/button_Cancel'))
