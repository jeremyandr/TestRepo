...
for (int i = 1; i <= count; i++) {
    ...
    modifyObjectRequired = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData/td_Checkbox'), 'xpath', 'equals', 
        newxpathRequired, true)

    modifyObjectCheckbox = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData/input_Checkbox'), 'xpath', 
	...
	modifyObjectDocumentName = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabLifeInsuranceData/td_SubjectName'), 'xpath',
 'equals', newxpathDocumentName, true)
    ...
    if (textRequired == 'NO') {
		...
		def checkNO = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData').getValue(GlobalVariable.NumofColm, 4).split(";",-1)
		...
		def uncheckYES = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData').getValue(GlobalVariable.NumofColm, 2).split(";",-1)
		...
		modifyObjectPromiseDate = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabLifeInsuranceData/td_SubjectName'), 'xpath',
	  'equals', newxpathPromiseDate, true)
		  
		def PromiseDate = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData').getValue(GlobalVariable.NumofColm, 3).split(";",-1)
			...
			'Looping dokumen uncheckYES'
			 for(j=1;j<=uncheckYES.size();j++){
				 ...
				 if(textDocumentName.equalsIgnoreCase(uncheckYES[j-1])){
					 ...
					 if(findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData').getValue(GlobalVariable.NumofColm, 3).length()>0){
						 'Input Promise Date'
	...
	newxpathExpiredDate = '//*[@id="TC-tab"]/app-tc-data/div/div/div/div/div/form/div/app-term-conditions/div/table/tbody/tr['+i+']/td[8]/input'
	 ...
	 modifyObjectExpiredDate = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData/input_expiredDate'), 'xpath',
		 'equals', newxpathExpiredDate, true)
	 
	 modifyObjectWaived = WebUI.modifyObjectProperty(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData/input_waived'), 'xpath',
		 'equals', newxpathWaived, true)
	 
	 def expiredDateDocument = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData').getValue(GlobalVariable.NumofColm, 5).split(";",-1)
	 
	 def expiredDate = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData').getValue(GlobalVariable.NumofColm, 6).split(";",-1)
	 ...
	 def waivedDocument = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData').getValue(GlobalVariable.NumofColm, 7).split(";",-1)
...
'Save'
WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData/button_Save'))
...
'Verify input data'
if (WebUI.verifyMatch(WebUI.getText(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/ApplicationCurrentStep')), 'TERM AND CONDITION', false, FailureHandling.OPTIONAL)) {
	
	'click cancel'
	WebUI.click(findTestObject('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP2-ApplicationData/TabTermConditionData/button_Cancel'))
