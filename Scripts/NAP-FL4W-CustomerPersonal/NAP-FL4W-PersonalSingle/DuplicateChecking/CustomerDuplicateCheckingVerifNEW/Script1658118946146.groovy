...
ExcelData MatrixRuleDupcheck = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/DuplicateCheckingRule')
...
dataCustomer = findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/NAP1-CustomerData/TabCustomerData')
...
for (row = 13; row <= (GlobalVariable.countRowPersonal + 12); row++) {
	...
	for (colm = 3; colm <= (GlobalVariable.countColmPersonal + 2); colm++) {
		if (findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/DuplicateCheckingRule').getValue(colm,
			row).equalsIgnoreCase(datacust[(colm - 3)]) || findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/DuplicateCheckingRule').getValue(
			colm, row).equalsIgnoreCase('Partial')) {
			(Results[(row - 13)]).add('Yes')
		} else if (findTestData('NAP-FL4W-CustomerPersonal/NAP-FL4W-CustomerPersonalSingle/DuplicateCheckingRule').getValue(
