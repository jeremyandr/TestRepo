...
public class DupCheckVerif {
	...
	public checkDupcheck (Sql instance, String appNo){
		...
		instance.eachRow(("select count(BUSINESS_KEY_) from [dbo].[ACT_HI_PROCINST] AHP join [dbo].[ACT_HI_VARINST] AHV on AHP.PROC_INST_ID_ = AHV.PROC_INST_ID_ where BUSINESS_KEY_ = '" + appNo + "' and AHV.PROC_DEF_KEY_ = 'WF_DUP_CHECK_MD_FL4W' and AHV.TEXT_ = 'true'"), {  row ->
